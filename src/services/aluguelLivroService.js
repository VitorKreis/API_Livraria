...
class AluguelLivroService {
  ...
  async calcularDataDevolucao(dataAlugada, diasAlugado){
    const data_Devolucao = new Date(dataAlugada.setDate(dataAlugada.getDate()));
    data_Devolucao.setDate(data_Devolucao.getDate() + diasAlugado);
